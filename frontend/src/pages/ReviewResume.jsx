...
const ReviewResume = () => {
  ...
  return (
    ...
    onSubmit={onSubmitHandler}
      ...
      <input placeholder='e.g., watch or spoon , Only single object name'
        onChange={(e)=>setInput(e.target.value)}  type='file' required
          className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300' 
        />
        <p className='text-xs text-gray-500 font-light mt-1'>Supports PDF only
      ...
      <div className='flex-1 flex justify-center items-center'>
        <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
           <FileText className='w-9 h-9 ' />
            <p className=''>Upload and image and click "Review Resume" to get started</p>
        </div>
