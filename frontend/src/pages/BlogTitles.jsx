...
const BlogTitles = () => {
  const blogCategories=['General','Business','Technology','Health','Lifestyle','Education','Travel','Food']
        ...
        <div className='flex-1 flex justify-center items-center'>
          <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
             <Hash className='w-9 h-9 ' />
              <p className=''>Enter a topic and click “Generate Title ” to get started</p>
          </div>
